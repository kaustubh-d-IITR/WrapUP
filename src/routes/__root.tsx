...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "WrapUP — AI Travel Planner" },
      { name: "twitter:title", content: "WrapUP — AI Travel Planner" },
      { property: "og:description", content: "Plan beautiful trips in seconds with WrapUP, your AI travel co-pilot." },
      { name: "twitter:description", content: "Plan beautiful trips in seconds with WrapUP, your AI travel co-pilot." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c59b72d5-0178-4afe-a584-00ab17a12e99" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c59b72d5-0178-4afe-a584-00ab17a12e99" },
